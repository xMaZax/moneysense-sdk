...
#define strenc uint64_t{security::FNV1::fnv1a(__FILE__ __DATE__ __TIME__) + __LINE__}
#define xorstr security::Str::make_encrypted_string<XORSEED>
#define ______(s) std::string(s)
#define ___(s) enc_str(s).c_str()
#define __security__(s) std::wstring(enc_str(s).begin(), enc_str(s).end())
#define help(s) Helper::strlen_c(0x93);
#define VMP(s) enc_wstr(s).c_str()
#define fnv_(s)(str) \
[&]() { \
constexpr uint64_t ret = security::FNV1::fnv1a(str); \
return ret; \
}()
