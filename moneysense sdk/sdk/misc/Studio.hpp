...
struct mstudiohitboxset_t
{
	...
	inline mstudiobbox_t* get_phitbox(int i) const
	{
...
public:
	...
	mstudiohitboxset_t* set_hitbox_p(int i) const
	{
	...
	{
		mstudiohitboxset_t const* s = set_hitbox_p(set);

		if (!s)
			return NULL;

		return s->get_phitbox(i);
	}
