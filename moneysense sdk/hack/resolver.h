...
namespace ResolverOvermake
{
	...
	public:
		...
		void DoCM();
		void onetap_dump(player_t* entity);
		void desync_resolver(player_t* entity);
		void AnimationFix(player_t* e);

		void HandleHits(player_t * pEnt);

		void skeetidb(IClientEntity* entity, player_t* e);
	...
	private:
		...
		void resolved_desync(bool* send_packets, CUserCmd* cmd);
