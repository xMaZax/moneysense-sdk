...
float weapon_t::get_innacuracy() {
	return call_virtual<float(__thiscall*)(void*)>(this, 478)(this);
}

float weapon_t::get_spread() {
	return call_virtual<float(__thiscall*)(void*)>(this, 448)(this);
}

void weapon_t::update_accuracy_penality() {
	call_virtual<void(__thiscall*)(void*)>(this, 479)(this);
}
...
bool weapon_t::is_pistol() {
	...
	return weapon_id == WEAPON_DEAGLE || weapon_id == WEAPON_ELITE || weapon_id == WEAPON_FIVESEVEN || weapon_id == WEAPON_P250 ||
		weapon_id == WEAPON_GLOCK || weapon_id == WEAPON_P2000 || weapon_id == WEAPON_CZ75 || weapon_id == WEAPON_USPS || weapon_id == WEAPON_TEC9 || weapon_id == WEAPON_REVOLVER;
}
...
Vector player_t::get_eye_pos_vector() {
...
float player_t::get_max_desync_delta() {
	uintptr_t animstate = uintptr_t(this->get_animation_state());
...
bool player_t::is_alive_local()
{
	...
	return g_ctx.m_local->m_lifeState() == LIFE_ALIVE;
}
