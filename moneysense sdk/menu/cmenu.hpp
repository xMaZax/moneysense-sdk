...
class globalcheckbox : public C_Control {
public:
	void draw();
	void update();
	void click();
public:
	...
	globalcheckbox(std::string n_label, bool* n_state, std::vector< C_ControlFlag* > n_flags = { });
};

class checkboxbind : public C_Control {
public:
	void draw();
	void update();
	void click();
public:
	...
	checkboxbind(std::string n_label, bool* n_state, ButtonCode_t* n_key, std::vector< C_ControlFlag* > n_flags = { });
};

class slidercheckbox : public C_Control {
public:
	void draw();
	void update();
	void click();
public:
	...
	slidercheckbox(std::string n_label, bool* n_state, int* n_value, int n_min, int n_max, std::vector< C_ControlFlag* > n_flags = { });
};
...
class C_Selector : public C_Control {
public:
	void draw();
	void update();
	void click();
public:
	...
	C_Selector(std::string n_label, int* n_selected, std::vector< std::string > n_items, std::vector< C_ControlFlag* > n_flags = { });
	C_Selector(std::string n_label, int* n_selected, std::vector< std::string >* n_items, std::vector< C_ControlFlag* > n_flags = { });
};
