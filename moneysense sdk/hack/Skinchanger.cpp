		...
		if (pEntity)
		{
			...
			if (g_cfg.skins.skinenabled || g_cfg.skins.knifes)
			{
				...
				case 9: // AWP
				{
					...
					case 22: pWeapon->m_nFallbackPaintKit() = 102; break; //
					default: break;
					}
				} break;
				case 61: // USP
				{
					...
					case 10:  pWeapon->m_nFallbackPaintKit() = 102; break; //
					default: break;
					}
				} break;
				case 4: // Glock
				...
				case 38: // Scar 20
				{
					...
					case 12:
						...
						break;
					case 13:
						pWeapon->m_nFallbackPaintKit() = 102;//Bloodsport
						break;
					default:
						break;
					}
				...
				case 40: // SSG08
				{
					...
					case 16:
						...
						break;
					case 17:
						pWeapon->m_nFallbackPaintKit() = 102;//624: 'Dragonfire'
						break;
					default:
						break;
					}
