#include "..\cmenu.hpp"
globalcheckbox::globalcheckbox(std::string n_label, bool* n_state, std::vector< C_ControlFlag* > n_flags) {
...
void globalcheckbox::update() {
}
void globalcheckbox::click() {
	*state = !(*state);
}
