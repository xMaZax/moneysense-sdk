...
public:
	...
	NETVAR(vec3_t, origin, "CBaseEntity", "m_vecOrigin");
...
public:
	...
	{
		return *reinterpret_cast<int*>(uintptr_t(this) + netvars::get().get_offset("CBaseCombatCharacter", "m_hActiveWeapon")) & 0xFFF;
	}
	int GetFireReadyTime()
	{
		return *(int*)((DWORD)this + netvars::get().get_offset("DT_WeaponCSBase", "m_flPostponeFireReadyTime"));
	}
	CBaseHandle m_hWeaponWorldModel()
	{
	...
	int ammo()
	{
		static int m_iClip1 = netvars::get().get_offset("DT_BaseCombatWeapon", "m_iClip1");
...
public:
	NETVAR(float, is_bomb, "DT_PlantedC4", "m_flC4Blow");
	NETVAR(bool, m_bClientSideAnimation, "CBaseAnimating", "m_bClientSideAnimation");
	NETVAR(float, m_flHealthShotBoostExpirationTime, "CBaseEntity", "m_flHealthShotBoostExpirationTime");
	...
	NETVAR(int, m_iEFlags, "CBasePlayer", "m_iEFlags");
	...
	NETVAR(int, smoke_grenade_tick_begin, "DT_SmokeGrenadeProjectile", "m_nSmokeEffectTickBegin");
	...
	bool is_alive_hk() {
		return call_virtual<bool(__thiscall*)(void*)>(this, 153)(this);
	}
	...
	player_t* get_local_player()
	{
		...
		const auto local = reinterpret_cast<player_t*>(g_csgo.m_entitylist()->GetClientEntity(g_csgo.m_engine()->GetLocalPlayer()));
	...
	bool is_enemy()
	{
		...
		return local->m_iTeamNum() != m_iTeamNum();
	}

	Vector get_ragdoll_pos()
	{
		return *reinterpret_cast<Vector*>(uintptr_t(this) + netvars::get().get_offset("DT_Ragdoll", "m_ragPos"));
	}

	player_t* get_max_health() {
		typedef player_t* (__thiscall * Fn)(void*);
		return call_virtual< Fn >(this, 122)(this);
	}
	int get_money_player()
	{
		static int m_iAccount = 0x2FC8;
		return *(int*)((DWORD)this + (m_iAccount));
	}
...
public:
	...
	NETVAR(CHandle<viewmodel_t>, is_hWeapon, "CBaseViewModel", "m_hWeapon");
